...
#flopen = open(r'73 tables final/p20.txt','r+')
flopen = open(r'Tables67/new 1.txt','r+')
...
while row<len(col_nums):
    ...
    if col_nums[row]<max_num_of_col:
        ...
        while n<col_nums[row]:
            row_col_dat[row].append([row,calc_col_num(lst[row][n][1])])
...
workbook = xlsxwriter.Workbook('67test1.xlsx')
